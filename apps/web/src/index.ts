...
export const webRuntimeManifest = {
  ...
  routeGroups: {
    ...
    adminCrm: ["/client", "/client/bookings", "/client/settings", "/admin/quotes", "/admin/contracts", "/admin/appointment-types", "/admin/emails", "/admin/email-templates", "/admin/scheduled-tasks"],
